...
import React, { forwardRef, memo, createContext, useContext, useMemo, Fragment, isValidElement, cloneElement, useCallback, Children, useRef, useState, useId, useEffect, createElement } from "react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "text-sm max-md:hidden", children: [
    ...
    !registration.disable && /* @__PURE__ */ jsx(
      Button,
      {
        ...
        children: /* @__PURE__ */ jsx(Trans, { message: "Sign up" })
      }
    )
  ] });
}
function MobileButtons() {
  ...
  return /* @__PURE__ */ jsxs(MenuTrigger, { children: [
    ...
    /* @__PURE__ */ jsxs(Menu, { children: [
      ...
      !registration.disable && /* @__PURE__ */ jsx(Item$1, { value: "register", onSelected: () => navigate("/register"), children: /* @__PURE__ */ jsx(Trans, { message: "Sign up" }) })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      className: clsx(
        ...
        link2.animation && `animate__animated animate__repeat-3 animate__${link2.animation}`,
        radius,
...
export {
  ...
  useDateFormatter as aN,
  shallowEqual as aO,
  useAutoFocus as aP,
  useIsDarkMode as aQ,
  Checkbox as aR,
  hasNextPage as aS,
  ArrowDropDownIcon as aT,
  AvatarPlaceholderIcon as aU,
  useListbox as aV,
  Listbox as aW,
  Popover as aX,
  ...
  LockIcon as bd,
  SettingsIcon as be,
  removeEmptyValuesFromObject as bf,
  useRecaptcha as bg,
  LinkClipboardButton as bh,
  BarChartIcon as bi,
