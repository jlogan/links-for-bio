...
const IconList = React.lazy(() => import("./icon-list-412cd49d.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-27d3d69a.mjs"));
...
//# sourceMappingURL=admin-routes-0714efd3.mjs.map
