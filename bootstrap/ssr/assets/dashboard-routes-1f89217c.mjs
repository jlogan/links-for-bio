...
import { Link, useSearchParams, useNavigate, Outlet, useParams, useRoutes, Navigate } from "react-router-dom";
import { ay as useMediaQuery, aJ as getFromLocalStorage, s as setInLocalStorage, aK as Underlay, c as createSvgIcon, a8 as getBootstrapData, aL as useUserTimezone, m as message, Q as getInputFieldClassNames, an as useField, ao as Field, a9 as useIsMobileMediaQuery, aM as useSelectedLocale, aN as useDateFormatter, I as IconButton, X as KeyboardArrowLeftIcon, u as useSettings, ak as DateFormatPresets, aO as shallowEqual, A as List, G as ListItem, T as Trans, aP as useAutoFocus, e as useDialogContext, i as DialogFooter, B as Button, D as Dialog, g as DialogBody, v as DialogTrigger, a as apiClient, V as createEventHandler, aQ as useIsDarkMode, S as Skeleton, aR as Checkbox, d as useTrans, R as useNumberFormatter, aa as SelectForwardRef, O as Item, aS as hasNextPage, aT as ArrowDropDownIcon, M as FormSelect, aU as AvatarPlaceholderIcon, r as Tooltip, J as opacityAnimation, h as FormTextField, k as Chip, aV as useListbox, aW as Listbox, aX as Popover, a0 as ProgressCircle, aY as KeyboardArrowDownIcon, aZ as useListboxKeyboardNavigation, f as DialogHeader, F as Form, H as TextField, aw as SearchIcon, n as CloseIcon, ab as ProgressBar, Z as StaticPageTitle, q as queryClient, t as toast, j as showHttpErrorToast, w as ConfirmationDialog, a_ as errorStatusIs, a1 as IllustratedMessage, a2 as SvgImage, W as ButtonBase, a$ as UploadedFile, U as clamp, b0 as WorkspaceQueryKeys, o as onFormQueryError, b1 as useActiveWorkspaceId, b2 as useAuth, b3 as PersonalWorkspace, y as useValueLists, b4 as ExitToAppIcon, ae as MenuTrigger, af as Menu, a6 as LinkStyle, b5 as UnfoldMoreIcon, b6 as useUserWorkspaces, b7 as useActiveWorkspace, at as openDialog, l as CheckIcon, b8 as ProgressBarBase, p as FormattedDate, C as CustomMenu, N as Navbar, b9 as AdHost, aI as Footer$1, ba as useThemeSelector, ag as RemoteFavicon, ah as removeProtocol, bb as lazyLoader, bc as prefetchValueLists, bd as LockIcon, _ as FileUploadProvider, x as FormImageSelector, be as SettingsIcon, ac as LinkIcon, bf as removeEmptyValuesFromObject, bg as useRecaptcha, bh as LinkClipboardButton, bi as BarChartIcon, bj as ShareLinkButton, bk as shareLink, a3 as useNavigate$1, bl as WarningIcon, a7 as SiteConfigContext, bm as FloatingLinkOverlay, a5 as FullPageLoader, bn as ImageIcon, bo as SocialsList, bp as parse, bq as WidgetRenderers, br as BiolinkLayout, bs as RadioGroup, bt as Radio, bu as cssPropsFromBgConfig, bv as useCollator, bw as loadFonts, bx as notifySvg, by as useActiveUpload, av as UploadInputType, bz as Disk, bA as UnfoldLessIcon, aC as PageMetaTags, aD as PageStatus, aG as AuthRoute, aH as NotFoundPage } from "../server-entry.mjs";
...
import { E as EditIcon, S as SectionHelper, M as MoreHorizIcon, B as Breadcrumb, a as BreadcrumbItem } from "./Edit-a8279514.mjs";
    ...
    Field,
    {
      wrapperProps: mergeProps(
        wrapperProps,
        {
          onBlur: (e) => {
            var _a2;
            if (!((_a2 = objRef.current) == null ? void 0 : _a2.contains(e.relatedTarget))) {
...
function toSafeZoned(date, timeZone, disambiguation) {
  try {
...
function useBaseDatePickerState(selectedDate, props) {
  ...
  const min = props.min ? toSafeZoned(props.min, timezone) : void 0;
  const max = props.max ? toSafeZoned(props.max, timezone) : void 0;
  return {
    timezone,
    granularity,
    min,
...
function useDatatableData(endpoint2, params2, options, onLoad) {
  if (!params2.paginate) {
    params2.paginate = "preferLengthAware";
  }
  return useQuery({
...
function TableCell({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      id,
      className: style,
      children: /* @__PURE__ */ jsx("div", { className: "w-full min-w-0 overflow-hidden overflow-ellipsis", children: column.body(item, rowContext) })
    }
  );
}
...
function HeaderCell({ index }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        column.hideHeader ? /* @__PURE__ */ jsx("div", { className: "opacity-0", children: column.header() }) : column.header(),
...
function DeleteItemsDialog() {
  ...
  return /* @__PURE__ */ jsx(
    ConfirmationDialog,
    {
      ...
      isDanger: true,
      onConfirm: () => {
        deleteSelectedRows2.mutate(void 0, {
          onSuccess: () => close(),
          onError: (err) => {
...
const AceEditor = React.lazy(() => import("./ace-editor-c19b5ec1.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function CustomDashboardNavbar({
  children,
  className,
  hideToggleButton,
  ...props
  ...
  return /* @__PURE__ */ jsxs(
    Navbar,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx(CustomLogo, { className: "mr-4 md:mr-24" }),
        children
      ]
    }
  );
          ...
          /* @__PURE__ */ jsx(
            SectionHelper,
            {
              ...
              description: /* @__PURE__ */ jsx(
                Trans,
                {
                  message: "Add animation to draw attention to this link. :br Selected animation will repeat three times by default.",
                  values: { br: /* @__PURE__ */ jsx("br", {}) }
                }
              )
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-[repeat(auto-fill,minmax(95px,1fr))] gap-14", children: LinkAnimationList.map((animation, index) => /* @__PURE__ */ jsx(AnimationItem, { animationName: animation }, index)) })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxs(DialogFooter, { dividerTop: true, children: [
...
function AnimationItem({ animationName }) {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      className: clsx(
        "animate__animated flex h-64 items-center justify-center rounded border border-2 px-10 font-medium uppercase",
  ...
  return /* @__PURE__ */ jsxs(
    CrupdateWidgetDialog,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(ImageWidgetStyleFields, {}),
        /* @__PURE__ */ jsx(
          FormTextField,
          {
            placeholder: trans(message("Optional")),
...
function ImageWidgetStyleFields() {
  const styleType = useFormContext().watch("type");
  if (styleType === "avatar") {
    return /* @__PURE__ */ jsxs(
      FormSelect,
      {
        className: "mb-24",
        name: "avatarShape",
        label: /* @__PURE__ */ jsx(Trans, { message: "Shape" }),
        selectionMode: "single",
        children: [
          /* @__PURE__ */ jsx(Item, { value: "circle", children: /* @__PURE__ */ jsx(Trans, { message: "Circle" }) }),
          /* @__PURE__ */ jsx(Item, { value: "square", children: /* @__PURE__ */ jsx(Trans, { message: "Square" }) })
        ]
      }
    );
  }
  if (styleType === "default") {
    return /* @__PURE__ */ jsx(
      FormTextField,
      {
        ...
        min: 1,
        max: 100,
        label: /* @__PURE__ */ jsx(Trans, { message: "Width (%)" }),
        description: /* @__PURE__ */ jsx(Trans, { message: "Image width as a percentage of the page width." })
      }
    );
  }
  return null;
...
const ArticleBodyEditor$1 = React.lazy(
  () => import("./article-body-editor-6af4a3d9.mjs")
);
...
export {
  ...
  TabPanel as O,
  ChipField as P,
  useCurrentDateTime as Q,
  useStickySentinel as R,
  Switch as S,
  TuneIcon as T,
  DatatableDataQueryKey as U,
  downloadFileFromUrl as V,
  useNormalizedModels as W,
  Avatar as X,
  DataTable as Y,
  useDataTable as Z,
  slugifyString as _,
  ...
  USER_MODEL as a0,
  timestampFilter as a1,
  FormNormalizedModelField as a2,
  LineChart as a3,
  FormattedNumber as a4,
  PolarAreaChart as a5,
  BarChart as a6,
  GeoChart as a7,
  DateRangePresets as a8,
  ReportDateSelector as a9,
  FormatIndentDecreaseIcon as aA,
  FormatIndentIncreaseIcon as aB,
  FormatItalicIcon as aC,
  FormatListBulletedIcon as aD,
  FormatListNumberedIcon as aE,
  FormatUnderlinedIcon as aF,
  GradientIcon as aG,
  GroupIcon as aH,
  HelpOutlineIcon as aI,
  HorizontalRuleIcon as aJ,
  ListAltIcon as aK,
  MoreTimeIcon as aL,
  MoveDownIcon as aM,
  NoteIcon as aN,
  PersonAddIcon as aO,
  PriorityHighIcon as aP,
  PublicIcon as aQ,
  RedoIcon as aR,
  ShortcutIcon as aS,
  SmartDisplayIcon as aT,
  SwapVertIcon as aU,
  UndoIcon as aV,
  UploadIcon as aW,
  WidgetsIcon as aX,
  useFilter as aY,
  dashboardRoutes as aZ,
  ClicksReportCharts as aa,
  SharedDashboardRoutes as ab,
  ArticleEditorStickyHeader as ac,
  ArticleEditorTitle as ad,
  FontSelector$1 as ae,
  BooleanIndicator as af,
  InfoIcon as ag,
  AccountTreeIcon as ah,
  AddLinkIcon as ai,
  AnimationIcon as aj,
  ArrowBackIcon as ak,
  ArrowDownwardIcon as al,
  ArrowForwardIcon as am,
  ArrowRightAltIcon as an,
  ArrowUpwardIcon as ao,
  CodeIcon as ap,
  DateRangeIcon as aq,
  FilterAltIcon as ar,
  FormatAlignCenterIcon as as,
  FormatAlignJustifyIcon as at,
  FormatAlignLeftIcon as au,
  FormatAlignRightIcon as av,
  FormatBoldIcon as aw,
  FormatClearIcon as ax,
  FormatColorFillIcon as ay,
  FormatColorTextIcon as az,
  ...
  ChipList as h,
  DataTablePage as i,
  DeleteSelectedItemsAction as j,
  DataTableEmptyStateMessage as k,
  DataTableExportCsvButton as l,
  DataTableAddItemButton as m,
  chunkArray as n,
  AccordionItem as o,
  AddIcon as p,
  FormChipField as q,
  usePointerEvents as r,
  ColorIcon as s,
  ColorPickerDialog as t,
  updatedAtFilter as u,
  DeleteIcon as v,
  useSortable as w,
  DragIndicatorIcon as x,
  AceDialog as y,
  CustomPageDatatableFilters as z
};
//# sourceMappingURL=dashboard-routes-1f89217c.mjs.map
