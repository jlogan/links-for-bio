...
import { u as useSettings, C as CustomMenu, T as Trans, a as apiClient, N as Navbar, I as IconButton, s as setInLocalStorage, b as useLocalStorage, E as ErrorIcon, m as message, c as createSvgIcon, t as toast, q as queryClient, o as onFormQueryError, d as useTrans, e as useDialogContext, D as Dialog, f as DialogHeader, g as DialogBody, F as Form$1, h as FormTextField, i as DialogFooter, B as Button, j as showHttpErrorToast, k as Chip, l as CheckIcon, n as CloseIcon, p as FormattedDate, r as Tooltip, v as DialogTrigger, w as ConfirmationDialog, L as LoginIcon, x as FormImageSelector, y as useValueLists, z as DoneAllIcon, A as List, G as ListItem, H as TextField, J as opacityAnimation, S as Skeleton, K as createSvgIconFromTree, M as FormSelect, O as Item, P as Section, Q as getInputFieldClassNames, R as useNumberFormatter, U as clamp, V as createEventHandler, W as ButtonBase, X as KeyboardArrowLeftIcon, Y as MixedText, Z as StaticPageTitle, _ as FileUploadProvider, $ as useAppearanceEditorMode, a0 as ProgressCircle, a1 as IllustratedMessage, a2 as SvgImage, a3 as useNavigate$1, a4 as useBootstrapData, a5 as FullPageLoader, a6 as LinkStyle, a7 as SiteConfigContext, a8 as getBootstrapData, a9 as useIsMobileMediaQuery, aa as SelectForwardRef, ab as ProgressBar, ac as LinkIcon, ad as ExternalLink, ae as MenuTrigger, af as Menu, ag as RemoteFavicon, ah as removeProtocol, ai as FormRadioGroup, aj as FormRadio, ak as DateFormatPresets, al as prettyBytes, am as useSocialLogin, an as useField, ao as Field, ap as useResendVerificationEmail, aq as useUser, ar as useUploadAvatar, as as useRemoveAvatar, at as openDialog, au as openUploadWindow, av as UploadInputType, aw as SearchIcon, ax as isAbsoluteUrl, ay as useMediaQuery, az as useProducts, aA as FormattedPrice, aB as useCustomPage, aC as PageMetaTags, aD as PageStatus, aE as FormattedRelativeTime, aF as closeDialog, aG as AuthRoute, aH as NotFoundPage } from "../server-entry.mjs";
import { D as DashboardLayoutContext, M as MenuOpenIcon, C as CustomLogo, a as DashboardLayout, b as DashboardSidenav, c as DashboardContent, F as FilterOperator, d as FilterControlType, e as createdAtFilter, u as updatedAtFilter, f as FormDatePicker, g as FormSwitch, N as NameWithAvatar, h as ChipList, i as DataTablePage, j as DeleteSelectedItemsAction, k as DataTableEmptyStateMessage, l as DataTableExportCsvButton, m as DataTableAddItemButton, n as chunkArray, A as Accordion, o as AccordionItem, p as AddIcon, S as Switch, q as FormChipField, r as usePointerEvents, K as KeyboardArrowRightIcon, s as ColorIcon, t as ColorPickerDialog, v as DeleteIcon, w as useSortable, x as DragIndicatorIcon, y as AceDialog, z as CustomPageDatatableFilters, B as articlesSvg, T as TuneIcon, E as MoreVertIcon, G as themeValueToHex, H as Tabs, I as TabList, J as Tab, L as TabPanels, O as TabPanel, P as ChipField, Q as useCurrentDateTime, R as useStickySentinel, U as DatatableDataQueryKey, V as downloadFileFromUrl, W as useNormalizedModels, X as Avatar, Y as DataTable, Z as useDataTable, _ as slugifyString, $ as FileDownloadIcon, a0 as USER_MODEL, a1 as timestampFilter, a2 as FormNormalizedModelField, a3 as LineChart, a4 as FormattedNumber, a5 as PolarAreaChart, a6 as BarChart, a7 as GeoChart, a8 as DateRangePresets, a9 as ReportDateSelector, aa as ClicksReportCharts, ab as SharedDashboardRoutes, ac as ArticleEditorStickyHeader, ad as ArticleEditorTitle, ae as FontSelector, af as BooleanIndicator, ag as InfoIcon } from "./dashboard-routes-1f89217c.mjs";
import { useQuery, useMutation, useQueryClient, keepPreviousData } from "@tanstack/react-query";
import { S as SectionHelper, E as EditIcon, B as Breadcrumb, a as BreadcrumbItem, C as ChevronRightIcon } from "./Edit-a8279514.mjs";
import React, { useContext, Fragment, useState, Suspense, useRef, useEffect, useMemo, useId, useCallback, forwardRef, memo, isValidElement, cloneElement } from "react";
...
function AdminLayout() {
  return /* @__PURE__ */ jsxs(DashboardLayout, { name: "admin", leftSidenavCanBeCompact: true, children: [
    /* @__PURE__ */ jsx(CustomAdminNavbar, { size: "sm", menuPosition: "admin-navbar" }),
...
const userDatatableColumns = [
  ...
  },
  {
    key: "banned_at",
    allowsSorting: true,
    header: () => /* @__PURE__ */ jsx(Trans, { message: "Suspended" }),
    width: "w-96",
    body: (user) => user.banned_at ? /* @__PURE__ */ jsx(CheckIcon, { className: "text-danger icon-md" }) : null
  },
  {
    key: "last_login",
    width: "w-110",
    header: () => /* @__PURE__ */ jsx(Trans, { message: "Last active" }),
    body: (user) => user.last_login ? /* @__PURE__ */ jsx("time", { children: /* @__PURE__ */ jsx(FormattedDate, { date: user.last_login.created_at }) }) : "-"
  },
  {
    key: "createdAt",
    allowsSorting: true,
...
const IconList = React.lazy(() => import("./icon-list-0d0eb1da.mjs"));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      FormTextField,
      {
        ...
        description: /* @__PURE__ */ jsx(LearnMoreLink, { link: "https://support.vebto.com/hc/articles/35/primary-site-url" })
      }
    ),
    append
  ] });
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(
                    Button,
                    {
                      ...
                      children: submitButtonText ?? /* @__PURE__ */ jsx(Trans, { message: "Save" })
                    }
                  )
                ]
              }
...
function CrupdateRolePageSettingsPanel({
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-14 mt-30 flex items-end justify-between gap-12", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg leading-tight", children: /* @__PURE__ */ jsx(Trans, { message: "Permissions" }) }),
      /* @__PURE__ */ jsx(
        Button,
        {
          variant: "outline",
          ...
          children: /* @__PURE__ */ jsx(Trans, { message: "Remove all" })
        }
      )
    ] }),
    /* @__PURE__ */ jsx(
...
const AdminReportPageColGap = "gap-12 md:gap-16 mb-12 md:mb-16";
...
const ReportsPage = React.lazy(() => import("./admin-report-page-08dbdf1f.mjs"));
...
//# sourceMappingURL=admin-routes-2e921a94.mjs.map
