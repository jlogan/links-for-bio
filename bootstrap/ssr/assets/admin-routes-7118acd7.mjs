...
const IconList = React.lazy(() => import("./icon-list-f44a9199.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-5875918d.mjs"));
...
//# sourceMappingURL=admin-routes-7118acd7.mjs.map
