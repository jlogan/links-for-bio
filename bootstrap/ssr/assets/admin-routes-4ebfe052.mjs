...
const IconList = React.lazy(() => import("./icon-list-6a7ab90a.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-1aaaf0fc.mjs"));
...
//# sourceMappingURL=admin-routes-4ebfe052.mjs.map
