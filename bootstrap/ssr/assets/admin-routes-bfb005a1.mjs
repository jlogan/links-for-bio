...
const IconList = React.lazy(() => import("./icon-list-36a3bc65.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-b36e594d.mjs"));
...
//# sourceMappingURL=admin-routes-bfb005a1.mjs.map
